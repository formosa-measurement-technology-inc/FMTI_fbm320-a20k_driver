...
/* Driver description
 *
 * File Name    : fbm320_a20k.c
 * Authors      : conrad@fmti.com.tw
 * Version      : 1.0.0
 * Date         : 2019/6/25
 * Description  : FBM320-A20K pressure sensor API for MCU of ARM_M0 core
 *
 */
...
#define P_CONFIG_REG_GAIN_SETTING FBM320_P_CONFIG_REG_GAIN_X8
...
int fbm320_calculation(struct fbm320_data *barom)
{
	...
	case hw_ver_b4:
		...
		X13 = ((X11 + X12) >> 11) + ((cali->C4 + 120586) << 3);
